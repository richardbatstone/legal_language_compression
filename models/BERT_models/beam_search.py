...
class SequenceBeamSearch(object):
  ...
  def __init__(self, symbols_to_logits_fn, vocab_size, batch_size,
               beam_size, alpha, max_decode_length, eos_id, decoder_embeddings, decoder_stack):
  ...
  def _continue_search(self, state):
    ...
    return not_at_max_decode_length
  ...
  def _grow_alive_seq(self, state):
    ...
    flat_logits, flat_cache = self.symbols_to_logits_fn(flat_ids, i, flat_cache, self.decoder_embeddings, self.decoder_stack)
...
def sequence_beam_search(
    ...
    alpha, max_decode_length, eos_id, decoder_embeddings, decoder_stack):
